...
const questionBank: Question[] = [
  // EASY - Synonym questions
  {
    ...
    correctAnswer: 1,
    explanation: '"Joyful" means the same as happy - feeling great pleasure and delight!',
    difficulty: 'easy'
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: '"Quick" is a synonym of fast - both mean moving or happening rapidly!',
    difficulty: 'easy'
  },
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: '"Short" is the antonym of tall - they describe opposite heights!',
    difficulty: 'easy'
  },
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: '"Beautiful" describes something that looks lovely or pleasing!',
    difficulty: 'easy'
  },
  // MEDIUM - Synonym questions
  {
    ...
    correctAnswer: 0,
    explanation: '"Clever" means the same as smart - being intelligent and quick to understand!',
    difficulty: 'medium'
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation: '"Brave" means the same as courageous - showing no fear in difficult situations!',
    difficulty: 'medium'
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation: '"Old" is a synonym of ancient - both refer to something from long ago!',
    difficulty: 'medium'
  },
  // MEDIUM - Antonym questions
  {
    ...
    correctAnswer: 1,
    explanation: '"Difficult" is the opposite of easy - it means hard or challenging!',
    difficulty: 'medium'
  },
  {
    id: 12,
    ...
    correctAnswer: 0,
    explanation: '"Fearful" is the opposite of brave - being afraid versus being courageous!',
    difficulty: 'medium'
  },
  {
    id: 13,
    ...
    correctAnswer: 1,
    explanation: '"Selfish" is the opposite of generous - thinking only of yourself versus being giving!',
    difficulty: 'medium'
  },
  // MEDIUM - Usage questions
  {
    ...
    correctAnswer: 1,
    explanation: '"Quietly" describes doing something without making much noise!',
    difficulty: 'medium'
  },
  {
    id: 15,
  ...
  // HARD - Synonym questions
  {
    ...
    correctAnswer: 1,
    explanation: '"Splendid" means the same as magnificent - both describe something impressively beautiful!',
    difficulty: 'hard'
  },
  {
    id: 17,
    ...
    correctAnswer: 0,
    explanation: '"Determined" is a synonym of persistent - continuing firmly despite difficulties!',
    difficulty: 'hard'
  },
  {
    id: 18,
    ...
    correctAnswer: 2,
    explanation: '"Plentiful" means the same as abundant - existing in large quantities!',
    difficulty: 'hard'
  },
...
export default function App() {
  ...
  useEffect(() => {
    localStorage.setItem('wordmaster-bookmarks', JSON.stringify(bookmarkedWords));
  }, [bookmarkedWords]);
  ...
  const shuffleQuestions = (difficulty: Difficulty) => {
  ...
  const handleToggleBookmark = (word: string) => {
    ...
    const isCurrentlyBookmarked = bookmarkedWords.some(bw => bw.word === word);
  ...
  const currentQuestion = questions[currentQuestionIndex];
  const isQuizComplete = currentQuestionIndex === questions.length - 1 && answered;
  const isCurrentWordBookmarked = bookmarkedWords.some(bw => bw.word === currentQuestion.word);
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700">Learn synonyms, antonyms, and word usage!</p>
        </div>
